...
\begin{figure}[h]
  ...
  \caption{$J_2$ error against total primal space--time degrees of freedom for adaptive iterations 0--6 and the uniform sequence 0--3.}
  \label{fig:lshape-j1-comparison}
\end{figure}

\begin{table}[h]
\centering
\caption{Representative fitted-$J_2$ results.}
...
\yue{fixed! but goal error increases from 6 to 7. I excluded ite 7 in Fig 3.10 for now. refined meshes below still uses ite 7}
