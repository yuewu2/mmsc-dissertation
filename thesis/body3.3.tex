...
To verify algebraic completeness as stated in \cref{sec:bbm-mixed-ridge-specialisation}, each adaptive iterate is post-processed on the same primal solution, adjoint solution, and mesh in two ways: with all recovered entities and after deleting only the signed mixed-ridge contribution. 如果之前define 了gap再看一下。Define
\begin{equation}
  \delta_{\mathrm{loc}}
