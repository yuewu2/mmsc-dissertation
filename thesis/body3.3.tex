...
The global estimator uses the nonlinear DWR identity with the unknown cubic remainder omitted~\cref{eq:localised-symmetric-nonlinear-dwr}. The low-order and enriched spaces are, respectively,
\begin{equation*}
  V_h^{\mathrm{low}}=\mathrm{dG}(1)_x\otimes\mathrm{dG}(0)_t,
  \qquad
  V_h^+=\mathrm{dG}(2)_x\otimes\mathrm{dG}(1)_t.
...
\begin{figure}[!htbp]
  ...
  \begin{subfigure}[b]{0.90\linewidth}
    ...
    \caption{Iteration 12: $2966$ cells.}
  \end{subfigure}
  \caption{Evolution of the independently refined slabwise space--time mesh.}
  \label{fig:bbm-mesh-evolution}
\end{figure}

Finally, selected iterations are listed in \cref{tab:bbm-results}. The goal error remains appreciable because a narrow nonlinear wave is transported over a long time interval on relatively modest meshes. The main estimator result is the improvement in effectivity from $0.7306$ to $0.9298$.
\begin{table}[htbp]
  \centering
  % \small
  ...
  \begin{tabular}{rrrrrrr}
    \toprule
    Iter. & Cells & $N_t$ & Terminal DoFs & $|J_{\mathrm{ref}}-J(u_h)|$
      & $I_{\mathrm{eff}}^{\mathrm{glob}}$ \\
    \midrule
     0 &   300 &   6 &  50 & 1.172006 & 0.730579 \\
     % 6 &   571 &   9 &  74 & 1.110802 & 0.765569 \\
     8 &   843 &  12 &  83 & 1.041180 & 0.818794 \\
    % 10 &  1653 &  20 & 101 & 0.862186 & 0.947709 \\
    12 &  2966 &  31 & 126 & 0.751703 & 0.967864 \\
    % 14 &  6694 &  57 & 163 & 0.540380 & 0.968159 \\
    16 & 15926 & 111 & 194 & 0.364666 & 0.929799 \\
    18 & 41682 & 226 & 279 & 0.232930 & 0.877563 \\
    20 & 115015 & 452 & 425 & 0.158710 & 0.794674 \\
    \bottomrule
  \end{tabular}
