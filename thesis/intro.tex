...
The objective of this dissertation is to develop and investigate an automated, goal-oriented, slabwise space--time adaptive finite element workflow whose local indicators are constructed from the weak variational problem rather than from a problem-specific strong-residual derivation. 

A bubble--cone residual recovery is extended from stationary finite element problems to discontinuous-Galerkin time slabs. The construction distinguishes volume, spatial-facet, and temporal-face residual entities and combines them into signed cell--slab DWR contributions.
