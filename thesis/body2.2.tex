...
For the nonlinear identity, the implemented estimator is
\begin{equation}
 \eta
 =
...
\end{equation}
To assess the quality of localisation, we define the localisation effectivity index
\begin{equation}
