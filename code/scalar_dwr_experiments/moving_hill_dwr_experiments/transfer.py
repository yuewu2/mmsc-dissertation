...
class SlabInterfaceTransfer:
    ...
    target_mass: Any
    source_mass_ksp: Any
    primal_boundary_conditions: Callable[[Any, Any], list[Any]]
    adjoint_boundary_conditions: Callable[[Any], list[Any]]
    ...
    def forward(self, source: Function, name: str, boundary_time=None) -> Function:
        ...
        for bc in self.primal_boundary_conditions(self.target_space, boundary_time):
            bc.apply(target)
        return target
    ...
    def adjoint(self, target_dual: Function, name: str) -> Function:
        ...
        for bc in self.adjoint_boundary_conditions(self.source_space):
...
def build_slab_interface_transfer(problem, source_space, target_space) -> SlabInterfaceTransfer:
    ...
    return SlabInterfaceTransfer(
        ...
        primal_boundary_conditions=problem.boundary_conditions,
        adjoint_boundary_conditions=problem.adjoint_boundary_conditions,
    )
